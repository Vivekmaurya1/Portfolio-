    ...
    <section id="about" className="section">
        <div className="container">
            ...
            <div className="two-col">
                ...
                {/* Bio */}
                <RevealLeft>
                    <div style={{ lineHeight: 1.85, fontSize: 'clamp(0.95rem, 1.6vw, 1.02rem)', color: 'var(--muted)' }}>
                        ...
                        <p style={{ marginBottom: '1.4rem' }}>
                            ...
                            I architect REST APIs that scale, write optimised queries, and integrate AI agent logic into robust backend platforms.
                        </p>
                        <p style={{ marginBottom: '2rem' }}>
                            Semi-finalist at <strong style={{ color: 'var(--bright)' }}>Smart India Hackathon</strong>.
                            Computer Engineering graduate, CGPA 8.05.
                        </p>
                        <blockquote style={{
                ...
                <RevealRight delay={0.1}>
                    <div>
                        ...
                        <div style={{
                            ...
                            {STRENGTHS.map(s => (
                                <div key={s} className="card" style={{ padding: '0.75rem 1rem', display: 'flex', alignItems: 'center', gap: '0.55rem' }}>
                                    <span style={{ width: 5, height: 5, borderRadius: '50%', background: 'var(--accent)', flexShrink: 0, display: 'inline-block' }} />
                                    <span style={{ fontFamily: 'var(--mono)', fontSize: 'clamp(0.65rem, 1.2vw, 0.72rem)', color: 'var(--text)' }}>{s}</span>
                                </div>
                            ))}
                        </div>
